		...
		<div class="container">
			...
			<nav class="collapse navbar-collapse" role="navigation">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="<%=request.getContextPath()%>/profile">Profile</a></li>
					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<h1>Congratulations, <sec:authentication property="principal.username" />! Your Profile has been updated successfully!</h1>
