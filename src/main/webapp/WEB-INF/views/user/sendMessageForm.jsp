			...
			<div class="col-md-3" id="leftCol">
				...
				<div class="well">
					<ul class="nav nav-stacked" id="sidebar">
						...
						<li class="active"><a href="<%=request.getContextPath()%>/message">Show Messages</a></li>
							...
							<div class="panel-body">
								...
								<form:form modelAttribute="message" action="" method="post">
									<div class="form-group">
										<form:label path="message" cssErrorClass="error"
											for="messageInput">Message: </form:label>
										<form:input path="message" class="form-control"
											id="messageInput" />
										<form:errors path="message" class="error"/>
									</div>
										<form:hidden path="fromUser" value="${from}" />
