      ...
      <div class="row row-offcanvas row-offcanvas-left">
         ...
         <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
            ...
            <ul class="nav nav-sidebar">
              <li><a href="<%=request.getContextPath()%>/employees">Overview</a></li>
              <li><a href="<%=request.getContextPath()%>/users">All Users</a></li>
              <li class="<%=request.getContextPath()%>/active"><a href="#">Moderator Users</a></li>
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <div class="panel-heading">Delete Successfully</div>
						<div class="panel-body">
							<a href="<%=request.getContextPath()%>/employees">Back to Admin Home Page</a>
						</div>
